...
from app.modules.broker_issues.router import router as broker_issues_router
...
api_router.include_router(broker_issues_router, dependencies=[Depends(require_admin)])
